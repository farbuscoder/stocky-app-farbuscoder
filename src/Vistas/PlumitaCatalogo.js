    ...
    <div className="display">
      ...
      <div className="content">
        <div className="grid-container">
          {(filtrados.length == 0 ? plumitas : filtrados).map((plumita) => {
            return <Item key={plumita._id} dato={plumita} />;
          })}
        </div>
      </div>
    </div>
...
export default PlumitaCatalogo;
